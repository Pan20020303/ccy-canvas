...
export const modelTemplates: Record<string, ModelTemplate> = {
  ...
  "minimax-h3-t2v-ref2v-turbo-local": {
    ...
    referenceImageRange: { min: 1, max: 9 },
    qualityOptions: ["极速", "官方8步", "音画分采8步", "均衡二采", "高质二采"],
    defaults: { resolution: "480p", aspectRatio: "16:9", quality: "极速" },
  },
  "minimax-h3-director-local": {
    vendor: "ComfyUI",
    modelName: "minimax-h3-director-local",
    serviceType: "video",
    supportsResolution: true,
    supportsAspectRatio: true,
    supportsDuration: true,
  ...
  "minimax-h3-u09-redraw-dual-fast-local": {
    vendor: "ComfyUI",
    modelName: "minimax-h3-u09-redraw-dual-fast-local",
    serviceType: "video",
    supportsResolution: true,
    supportsAspectRatio: true,
    supportsDuration: true,
    ...
    defaults: { resolution: "768p", aspectRatio: "16:9", quality: "平衡 8+3步" },
  },
  "minimax-h3-u09-no-codec-dual-upscale-local": {
    vendor: "ComfyUI",
    modelName: "minimax-h3-u09-no-codec-dual-upscale-local",
    serviceType: "video",
    supportsResolution: true,
    supportsAspectRatio: true,
    supportsDuration: true,
    ...
    defaults: { resolution: "768p", aspectRatio: "16:9", quality: "原生 20+3步" },
  },
  "minimax-h3-drama-workbench-local": {
    vendor: "ComfyUI",
    modelName: "minimax-h3-drama-workbench-local",
    serviceType: "video",
    supportsResolution: true,
    supportsAspectRatio: true,
    supportsDuration: true,
  ...
  "ltx-2.5-distilled-av-local": {
    vendor: "ComfyUI",
    modelName: "ltx-2.5-distilled-av-local",
    serviceType: "video",
    supportsResolution: true,
    supportsAspectRatio: true,
    supportsDuration: true,
    ...
    durationRange: { min: 3, max: 15, step: 1, defaultValue: 5 },
    referenceModes: ["text-to-video", "multi-image"],
    referenceImageRange: { min: 0, max: 6 },
    qualityOptions: ["极速", "标准", "高质量"],
    defaults: { resolution: "480p", aspectRatio: "16:9", quality: "标准" },
  },
